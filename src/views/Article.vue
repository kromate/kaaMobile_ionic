    ...
    <div class="ionCon">
      <ion-row class="ion-justify-content-center ">
        <ion-col class="ion-text-center ion-align-items-center">
          <h1>
            <span class="tex-primary">Articles</span>
          </h1>
          <p class="lead ">
      ...
      <div style="overflow-x: auto;">
        ...
        <ion-row class="ion-wrap ion-justify-content-center" v-else>
...
import { IonCol, IonRow, IonInput, IonSelect, IonSelectOption, IonPage } from "@ionic/vue";
